...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2026 at 12:56 PM
...
INSERT INTO `blogs` (`id`, `title`, `slug`, `content`, `excerpt`, `author`, `publication_date`, `tags`, `category_id`, `featured_image`, `status`, `view_count`, `created_at`, `updated_at`, `meta_title`, `meta_description`, `meta_keywords`, `schemas`, `schema_markup`) VALUES
(1, 'random-blog', 'random-blog', '<p>dsfadsafdsafdsa fdsa</p>\r\n\r\n<p>fdsa f</p>\r\n\r\n<p>dsaf ds</p>\r\n\r\n<p>af dsa fdsa fsd af</p>\r\n\r\n<p>ds af</p>\r\n\r\n<p>dsa fds a</p>\r\n\r\n<p>f ds</p>\r\n\r\n<p>a fdsaf ds</p>\r\n\r\n<p>a fdsa</p>\r\n', 'dsfdsa fdsafdsa fds\r\naf dsa\r\nf dsa f\r\ndsa f\r\nsd af dsa\r\nf ds\r\naf \r\ndsa f\r\nds a\r\nf dsa\r\nf \r\ndsa f\r\ndsa', 'Shivam Thakur', '2026-01-05', '[\"best travel agency in agra\",\"agra travel agency\",\"best travel agency in india\"]', 4, 'blog-tour.webp', 'published', 0, '2026-01-05 19:13:27', '2026-04-08 09:53:54', NULL, NULL, NULL, '[{\"type\":\"custom\",\"data\":{\"@context\":\"https://schema.org\",\"@type\":\"BlogPosting\",\"headline\":\"blog-schema-test-1775642034\"}}]', '[{\"type\":\"custom\",\"data\":{\"@context\":\"https://schema.org\",\"@type\":\"BlogPosting\",\"headline\":\"blog-schema-test-1775642034\"}}]');
...
INSERT INTO `page_seo` (`id`, `page_key`, `page_title`, `meta_description`, `meta_keywords`, `canonical_url`, `robots_meta`, `og_title`, `og_description`, `og_image`, `og_type`, `twitter_title`, `twitter_description`, `twitter_image`, `twitter_card`, `schema_markup`, `created_at`, `updated_at`) VALUES
(1, 'qa_test_page_1775642034', 'QA SEO Title', 'QA SEO Description', 'qa,test', 'https://indiadaytrip.com/qa-test', 'INDEX,FOLLOW', 'QA OG Title', 'QA OG Description', 'https://indiadaytrip.com/assets/img/logo/logo-header.webp', 'website', 'QA Twitter Title', 'QA Twitter Description', 'https://indiadaytrip.com/assets/img/logo/logo-header.webp', 'summary_large_image', '{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"QA Page\"}', '2026-04-08 09:53:54', '2026-04-08 09:53:54');
...
(1, 'contact_address', 'QA Address 1775642034', '2025-12-28 08:46:45', '2026-04-08 09:53:54'),
(2, 'contact_email', 'qa1775642034@example.com', '2025-12-28 08:46:45', '2026-04-08 09:53:54'),
(3, 'contact_mobile', '+91 90000 12345', '2025-12-28 08:46:45', '2026-04-08 09:53:54'),
(4, 'social_facebook', 'https://facebook.com/qa-profile', '2025-12-28 08:46:45', '2026-04-08 09:53:54'),
(5, 'social_twitter', 'https://twitter.com/qa-profile', '2025-12-28 08:46:45', '2026-04-08 09:53:54'),
(6, 'social_instagram', 'https://instagram.com/qa-profile', '2025-12-28 08:46:45', '2026-04-08 09:53:54');
...
CREATE TABLE `tours` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `internal_items` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`internal_items`)),
  `included_points` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`included_points`)),
  `excluded_points` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`excluded_points`)),
...
ALTER TABLE `blogs`
  ...
  ADD CONSTRAINT `fk_blogs_category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL;
